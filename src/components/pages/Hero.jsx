...
const Hero = () => {
  return (
    <section className=" md:pt-16 bg-yelow-900 pt-4  min-h-screen" id="home">
      <div className="container md:pt-4 pt-0">
        <div className="md:flex items-center justify-between sm:flex-col md:flex-row">
          <div className="w-full md:basis-2/3">
            ...
            <h1 className="text-headingColor font-[800] text-[1.5rem] sm:text-[38px] leading-[35px] sm:leading-[46px] mt-3">
              I,m Elvis Rono <br />
              Software Engineer
            </h1>
            ...
            <div className="flex items-center gap-9 mt-6">
              ...
              <span>
                <a
                  href="https://github.com/Elvisrono"
                  target="_blank"
              ...
              <span>
                <a
                  href="https://www.linkedin.com/in/elvisrono/"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="LinkedIn"
                  className="text-smallTextColor text-[30px] font-[600]"
